...
.form-container button {
    ...
    margin-bottom: 10px; /* Añadir margen inferior para separar botones */
}
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form method="post" action="registro.php" onsubmit="return validarFormulario()">
                <input type="text" id="numero_empleado" name="numero_empleado" maxlength="8" placeholder="Número de Empleado" required>
